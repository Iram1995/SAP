...
// Type: SAP2012.CO2_Emissions_12a2012
...
namespace SAP2012
{
  ...
  public class CO2_Emissions_12a2012
  {
    ...
    private CO2_Emissions_12a2012.AppendixQ_Items[] _AppendixQ_Item;
    private double _Box270;
    private double _Box271;
    private double _Box272;
    private double _Box273;
    private double _Box274;
    private double _CF;
    private double _EIValue;
    private string _EIBand;

    public override string ToString() => "12a. CO2 Emissions - for individual heating systems (including micro-CHP) and community heating without CHP";
    ...
    [Description("Electricity for pumps, fans and electric keep-hot Emissions Factor")]
    [ReadOnly(true)]
    ...
    [Description("Electricity for pumps, fans and electric keep-hot")]
    [ReadOnly(true)]
    ...
    [Description("Electricity for Lighting Emissions Factor")]
    [ReadOnly(true)]
    ...
    public double Box270
    {
      get
      {
        ...
        while (index <= num)
        {
          box270 += (float) this._AppendixQ_Item[index].Energy_Saved_Emissions;
          checked { ++index; }
        }
    ...
    public double Box271
    {
      get
      {
        ...
        while (index <= num)
        {
          box271 += (float) this._AppendixQ_Item[index].Energy_Used_Emissions;
          checked { ++index; }
        }
    ...
    public CO2_Emissions_12a2012.AppendixQ_Items get_AppendixQ_Item(int Index)
    {
      if (this._AppendixQ_Item[Index] == null)
        this._AppendixQ_Item[Index] = new CO2_Emissions_12a2012.AppendixQ_Items();
      return this._AppendixQ_Item[Index];
    }

    public void set_AppendixQ_Item(int Index, CO2_Emissions_12a2012.AppendixQ_Items value)
    {
      if (this._AppendixQ_Item[Index] == null)
        this._AppendixQ_Item[Index] = new CO2_Emissions_12a2012.AppendixQ_Items();
    ...
    [Description("")]
    [ReadOnly(true)]
    public CO2_Emissions_12a2012.AppendixQ_Items[] AppendixQ_Item => this._AppendixQ_Item;

    public int AppendixQ_Item_Count
    {
      set
      {
        this._AppendixQ_Item = new CO2_Emissions_12a2012.AppendixQ_Items[checked (value - 1 + 1)];
    ...
    [Description("Dwelling CO2 Emission Rate")]
    [ReadOnly(true)]
    public double EIValue
    {
      get => !SAP_Module.CalcRound ? this._EIValue : Math.Round(this._EIValue, SAP_Module.RoundFigure);
      set => this._EIValue = value;
    }

    [Description("Dwelling CO2 Emission Rate")]
    [ReadOnly(true)]
    public double Box274
    {
      get => this._Box274;
      set => this._Box274 = value;
    }
