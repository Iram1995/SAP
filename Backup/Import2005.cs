...
{
  [DesignerGenerated]
  public class Import2005 : Form
  {
    private IContainer components;
    private object ProjectImport;

    public Import2005() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.cmdProducts.Location = new Point(375, 20);
      ...
      this.Button1.Location = new Point(12, 508);
      ...
      this.GroupBox1.Size = new Size(516, 152);
      this.GroupBox1.TabIndex = 21;
      this.GroupBox1.TabStop = false;
      this.GroupBox1.Text = "Import from SAP 2005 dwelling files";
      this.lstFiles.Cursor = Cursors.Hand;
      this.lstFiles.FormattingEnabled = true;
      this.lstFiles.ItemHeight = 17;
      this.lstFiles.Location = new Point(6, 49);
      this.lstFiles.Name = "lstFiles";
      this.lstFiles.Size = new Size(492, 89);
      ...
      this.GroupBox2.Location = new Point(12, 355);
      this.GroupBox2.Name = "GroupBox2";
      this.GroupBox2.Size = new Size(511, 147);
      this.GroupBox2.TabIndex = 22;
      this.GroupBox2.TabStop = false;
      this.GroupBox2.Text = "Notes";
      this.Label4.AutoSize = true;
      this.Label4.Location = new Point(7, 95);
      this.Label4.Name = "Label4";
      this.Label4.Size = new Size(491, 34);
      this.Label4.TabIndex = 2;
      this.Label4.Text = "3) There will be a need to specify thermal mass parameters within the imported \r\ndwelling";
      this.Label3.AutoSize = true;
      this.Label3.Location = new Point(7, 51);
      this.Label3.Name = "Label3";
      this.Label3.Size = new Size(503, 34);
      ...
      this.Label2.Size = new Size(483, 17);
      ...
      this.GroupBox3.Location = new Point(12, 4);
      this.GroupBox3.Name = "GroupBox3";
      this.GroupBox3.Size = new Size(516, 187);
      this.GroupBox3.TabIndex = 23;
      this.GroupBox3.TabStop = false;
      this.GroupBox3.Text = "Import dwellings from a SAP 2005 project file";
      this.Label1.AutoSize = true;
      this.Label1.Location = new Point(7, 155);
      this.Label1.Name = "Label1";
      this.Label1.Size = new Size(243, 17);
      ...
      this.Button6.Location = new Point(275, 152);
      ...
      this.Button5.Location = new Point(371, 152);
      this.Button5.Name = "Button5";
      this.Button5.Size = new Size((int) sbyte.MaxValue, 23);
      ...
      this.CheckedListBox1.Size = new Size(492, 99);
      ...
      this.Button4.Location = new Point(275, 20);
      this.Button4.Name = "Button4";
      this.Button4.Size = new Size(223, 23);
      ...
      this.ClientSize = new Size(532, 572);
      ...
      this.Name = nameof (Import2005);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "Import 2005 FSAP Dwellings";
    ...
    private void Button2_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        this.OpenFileDialog1.Filter = "Stroma FSAP Dwelling (*.dwl2005)|*.dwl2005";
    ...
    private void cmdProducts_Click(object sender, EventArgs e)
    {
      ...
      Functions.Import_2005(strArray);
    }
    ...
    private void Button3_Click(object sender, EventArgs e)
    {
      ...
      {
        this.OpenFileDialog1.FileName = "";
        this.OpenFileDialog1.Filter = "Stroma FSAP Projects (*.sts)|*.sts";
        int num1 = (int) this.OpenFileDialog1.ShowDialog();
        try
        {
    ...
    private void Button4_Click(object sender, EventArgs e)
    {
      ...
      if ((uint) numArray.Length <= 0U)
        return;
      Functions.Import_2005(RuntimeHelpers.GetObjectValue(this.ProjectImport), numArray);
    }
