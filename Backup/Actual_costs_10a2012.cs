...
// Type: SAP2012.Actual_costs_10a2012
...
namespace SAP2012
{
  ...
  public class Actual_costs_10a2012
  {
    ...
    private double _HeatingCost;
    private Actual_costs_10a2012.AppendixQ_Items[] _AppendixQ_Item;
    ...
    [Description("Water Allocation Costs")]
    [ReadOnly(true)]
    public double Box249Water
    {
      get => !SAP_Module.CalcRound ? this._Box249Water : Math.Round(this._Box249Water, SAP_Module.RoundFigure);
      set => this._Box249Water = value;
    }
    ...
    {
      get => !SAP_Module.CalcRound ? this._HeatingCost : Math.Round(this._HeatingCost, SAP_Module.RoundFigure);
      set => this._HeatingCost = value;
    }

    public Actual_costs_10a2012.AppendixQ_Items get_AppendixQ_Item(int Index)
    {
      if (this._AppendixQ_Item[Index] == null)
        this._AppendixQ_Item[Index] = new Actual_costs_10a2012.AppendixQ_Items();
      return this._AppendixQ_Item[Index];
    }

    public void set_AppendixQ_Item(int Index, Actual_costs_10a2012.AppendixQ_Items value)
    {
      if (this._AppendixQ_Item[Index] == null)
        this._AppendixQ_Item[Index] = new Actual_costs_10a2012.AppendixQ_Items();
    ...
    [Description("")]
    [ReadOnly(true)]
    public Actual_costs_10a2012.AppendixQ_Items[] AppendixQ_Item => this._AppendixQ_Item;

    public int AppendixQ_Item_Count
    {
      set
      {
        this._AppendixQ_Item = new Actual_costs_10a2012.AppendixQ_Items[checked (value - 1 + 1)];
    ...
    public double Box253
    {
      get
      {
        ...
        while (index <= num)
        {
          box253 += (float) this._AppendixQ_Item[index].Energy_Saved_Cost;
          checked { ++index; }
        }
        return (double) box253;
      }
    }
    ...
    public double Box254
    {
      get
      {
        ...
        while (index <= num)
        {
          box254 += (float) this._AppendixQ_Item[index].Energy_Used_Cost;
          checked { ++index; }
        }
        return (double) box254;
      }
    }

    [Description("Total energy cost £/year")]
    [ReadOnly(true)]
