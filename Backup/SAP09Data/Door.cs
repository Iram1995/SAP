...
namespace SAP2012.SAP09Data
{
  ...
  [DataContract(Name = "Door", Namespace = "http://rdsap2009.stroma.com/SAPData/SAP09Compliance.asmx")]
  [Serializable]
  public class Door : IExtensibleDataObject, INotifyPropertyChanged
  {
    [NonSerialized]
    ...
    {
      get => this.DoorTypeField;
      set
      {
        if (object.ReferenceEquals((object) this.DoorTypeField, (object) value))
          return;
        this.DoorTypeField = value;
        this.RaisePropertyChanged(nameof (DoorType));
      }
    }
