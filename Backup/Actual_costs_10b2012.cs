...
// Type: SAP2012.Actual_costs_10b2012
...
namespace SAP2012
{
  ...
  public class Actual_costs_10b2012
  {
    ...
    private Actual_costs_10b2012.AppendixQ_Items[] _AppendixQ_Item;
    ...
    [ReadOnly(true)]
    public double Box349Water
    {
      get => !SAP_Module.CalcRound ? this._Box349Water : Math.Round(this._Box349Water, SAP_Module.RoundFigure);
      set => this._Box349Water = value;
    }
    ...
    public Actual_costs_10b2012.AppendixQ_Items get_AppendixQ_Item(int Index)
    {
      if (this._AppendixQ_Item[Index] == null)
        this._AppendixQ_Item[Index] = new Actual_costs_10b2012.AppendixQ_Items();
      return this._AppendixQ_Item[Index];
    }

    public void set_AppendixQ_Item(int Index, Actual_costs_10b2012.AppendixQ_Items value)
    {
      if (this._AppendixQ_Item[Index] == null)
        this._AppendixQ_Item[Index] = new Actual_costs_10b2012.AppendixQ_Items();
    ...
    [Description("")]
    [ReadOnly(true)]
    public Actual_costs_10b2012.AppendixQ_Items[] AppendixQ_Item => this._AppendixQ_Item;

    public int AppendixQ_Item_Count
    {
      set
      {
        this._AppendixQ_Item = new Actual_costs_10b2012.AppendixQ_Items[checked (value - 1 + 1)];
