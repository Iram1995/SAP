...
// Type: SAP2012.CO2_Emissions_12b2012
...
namespace SAP2012
{
  ...
  public class CO2_Emissions_12b2012
  {
    ...
    private CO2_Emissions_12b2012.AppendixQ_Items[] _AppendixQ_Item;
    private double _Box383;
    private double _Box384;
    private double _Box385;
    private double _CF;
    private double _EI;
    private double _EIRating;
    private string _EIBand;

    public override string ToString() => "12b. CO2 Emissions - for community heating schemes";
    ...
    [Description("Energy saving/generation Emission Factors")]
    [ReadOnly(true)]
    public double[] Box380_EFactors => this._Box380Ea;

    [Description("Energy saving/generation Emissions")]
    [ReadOnly(true)]
    public double[] Box380_Emissions => this._Box380a;
    ...
    public double Box381
    {
      get
      {
        ...
        while (index <= num)
        {
          box381 += (float) this._AppendixQ_Item[index].Energy_Saved_Emissions;
          checked { ++index; }
        }
    ...
    public double Box382
    {
      get
      {
        ...
        while (index <= num)
        {
          box382 += (float) this._AppendixQ_Item[index].Energy_Used_Emissions;
          checked { ++index; }
        }
    ...
    public CO2_Emissions_12b2012.AppendixQ_Items get_AppendixQ_Item(int Index)
    {
      if (this._AppendixQ_Item[Index] == null)
        this._AppendixQ_Item[Index] = new CO2_Emissions_12b2012.AppendixQ_Items();
      return this._AppendixQ_Item[Index];
    }

    public void set_AppendixQ_Item(int Index, CO2_Emissions_12b2012.AppendixQ_Items value)
    {
      if (this._AppendixQ_Item[Index] == null)
        this._AppendixQ_Item[Index] = new CO2_Emissions_12b2012.AppendixQ_Items();
    ...
    [Description("")]
    [ReadOnly(true)]
    public CO2_Emissions_12b2012.AppendixQ_Items[] AppendixQ_Item => this._AppendixQ_Item;

    public int AppendixQ_Item_Count
    {
      set
      {
        this._AppendixQ_Item = new CO2_Emissions_12b2012.AppendixQ_Items[checked (value - 1 + 1)];
    ...
    [Description("Dwelling CO2 Emission Rate")]
    [ReadOnly(true)]
    public double Box384
    {
      get => !SAP_Module.CalcRound ? this._Box384 : Math.Round(this._Box384, SAP_Module.RoundFigure);
      set => this._Box384 = value;
    }

    [Description("EI rating")]
    [ReadOnly(true)]
    public double Box385
    {
      get => !SAP_Module.CalcRound ? this._Box385 : Math.Round(this._Box385, SAP_Module.RoundFigure);
      set => this._Box385 = value;
    }
    ...
    public double EI
    {
      get => !SAP_Module.CalcRound ? this._EI : Math.Round(this._EI, SAP_Module.RoundFigure);
      set => this._EI = value;
    }

    [Description("Dwelling CO2 Emission Rate")]
    [ReadOnly(true)]
    public double EIRating
    {
      get => this._EIRating;
      set => this._EIRating = value;
    }
    ...
    public class AppendixQ_Items
    {
      ...
      [Description("Energy Saved Emission Factor")]
      [ReadOnly(true)]
      ...
      [Description("Energy Saved Emissions")]
      [ReadOnly(true)]
      public double Energy_Saved_Emissions
      {
      ...
      [Description("Energy Used Emission Factor")]
      [ReadOnly(true)]
      ...
      [Description("Energy Used Emissions")]
      [ReadOnly(true)]
      public double Energy_Used_Emissions
      {
